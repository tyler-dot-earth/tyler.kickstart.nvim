...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gdd', require('telescope.builtin').lsp_definitions, '[G]oto [D]efinition [D]irectly')
          map('gds', '<cmd>split<cr><cmd>Telescope lsp_definitions<CR>', '[G]oto [D]efinition [S]plit')
          map('gdv', '<cmd>vsplit<cr><cmd>Telescope lsp_definitions<CR>', '[G]oto [D]efinition [V]split')
...

  {
    ...
    config = function()
      -- Disable focus autoresize for certain buftypes
